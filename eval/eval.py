...
if __name__ == "__main__":
    ...
    updated_sim_matrix_path = f"/home/ouyang/Code/DepySM/data/Movielens/res/updated_similarity_{rewards['fd']}_{rewards['ind']}.json"
