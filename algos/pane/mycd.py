...
# Compute beta-divergence as the loss function, supporting multiple types (e.g., Frobenius norm, Kullback-Leibler divergence, Itakura-Saito divergence).
...
# Call the Cython-implemented efficient update function to complete a single round of updates for W or H.
...
# Iterative optimization process of coordinate descent, alternating updates of W and H to minimize the loss function.
...
# Main function for NMF decomposition: initializes W and H, calls the optimization method (coordinate descent) for iterative solving, and returns the factorization results.
